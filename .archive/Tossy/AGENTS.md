...
**Tossy** — Task orchestration and workflow management system

## Project Summary

This project provides declarative framework for defining, executing, and monitoring task pipelines with retry logic and comprehensive observability.
