...
func GetUserAccessToken(ctx *gin.Contextt, pasetoToken, code string)(*github.Authorization, error) {
...
func RefreshToken(ctx context.Context, pasetoToken, refreshToken string) (*github.Authorization, error) {
	secrets := models.GitSecret{}
	models.DB.First(&secrets)
	client := github.NewClient(nil)
	client.Auth = &github.Auth{
