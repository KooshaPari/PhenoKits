...
type Project struct {
	...
	Deployments []Instance `gorm:"foreignKey:RootProjectUUID;references:UUID"`
}
func (p *Project) GetDeployments() []Instance {
	return p.Deployments
}

func (p *Project) GetDeploymentByUUID(uuid string) *Instance {