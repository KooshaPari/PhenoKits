...
func UpdateLink(c *gin.Context ){ 
	...
	user.LLMConfig.Providers[user.LLMConfig.Provider] = models.AIProvider{
		Modal: "gpt-4o",
		APIKey: "rjlVz7QMlxHPTjI2RnZjrebmDnFFup2LwYpUuU5VRRSXeyclLglYadtroCnX/PndPxq623Tfx9tikN7LvEOGq3BEBMy9iLNganiT0JoYmGkP/lRahNgAPorSJGYIJ5vzKs1xjH5A+wqzU9jEHI7KqSCMdvKsTsRmV/UAcviz7k/JMa15vTpUt4hYIyDWsAMrtP24C64scleXCEI9SOvg0NzR",}
	models.DB.Save(&user)
