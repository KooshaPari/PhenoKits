        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(UserAPIKeys::APICreatedAt).timestamp_with_time_zone().default("CURRENT_TIMESTAMP").not_null())
                    .col(ColumnDef::new(UserAPIKeys::APIUpdatedAt).timestamp_with_time_zone().default("CURRENT_TIMESTAMP").not_null())
                    .foreign_key(
                        ForeignKey::create()
