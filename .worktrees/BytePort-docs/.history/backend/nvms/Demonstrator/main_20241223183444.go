...
URL path joining is incorrect and missing a slash:
The Authorization header is missing
Content-Type header is missing
We're marshaling a string that might already be JSON

Here's the corrected version:
goCopyfunc sendToPortfolio(object string, endpoint string, key string) error {
