...
func DeployProject(w http.ResponseWriter, r *http.Request) {
	...
	*/
	...
	for _, service := range nvmsConfig.Services {
		...
		DeployAWSService(accesskey,secretkey,service, codebase, rootDir)
		// TODO: Deploy MicroVM
...
func DeployAWSService(accessKey, secretKey string, Service lib.Service,zipBall []byte, rootDir string ) error {
