...
func DeployProject(w http.ResponseWriter, r *http.Request) {
	...
	*/
	...
	err = pushToS3(codebase, nvmsConfig.Services[0], accesskey,secretkey,nvmsConfig.Services[0].Name)
	if err != nil {
		return err
	}
...
func DeployAWSService(accessKey, secretKey string, Service models.Service,zipBall []byte) error {
