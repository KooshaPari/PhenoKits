...
type ProvisionerResponse struct {
	...
	FileMap map[string][]byte `json:"fileMap"`
}
...
func DeployNVMSService(AccessKey string, SecretKey string, Bucket lib.S3DeploymentInfo, service models.Service ) ([]lib.EC2InstanceInfo, error) {
	instances, err := lib.DeployEC2(AccessKey, SecretKey, Bucket, service, fuke )
	if err != nil {
