...
func DeployNVMSService(AccessKey string, SecretKey string, Bucket lib.S3DeploymentInfo, service models.Service, fileMap map[string]) ([]lib.EC2InstanceInfo, error) {
