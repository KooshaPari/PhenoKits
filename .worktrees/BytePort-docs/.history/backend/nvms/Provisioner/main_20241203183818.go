...
func init() {
    spinhttp.Handle(func(w http.ResponseWriter, r *http.Request) {
        ...
        request.Header.Set("Authorization", fmt.Sprintf("Bearer %s", authToken)) // Add token to headers
        request.Header.Set("Accept", "application/vnd.github+json") // Set accept header to GitHub API
        ...
        zipResp, err := spinhttp.Get(redirectURL)
        if err != nil {
