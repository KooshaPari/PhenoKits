...
func init() {
    ...
    spinhttp.Handle(func(w http.ResponseWriter, r *http.Request) {
        ...
        fsys, err := archives.FileSystem(nil, /tmp, bytes.NewReader(zipBytes))
if err != nil {
	return err
}
        /*
        ...
        err = format.Extract(nil,bytes.NewReader(zipBytes), func(ctx context.Context, f archives.FileInfo) error {
