...
Based on your log output and tree structure, here's the fixed version:
goCopyfunc matchesBuildpackInMemory(tree map[string][]string, detectFiles []string, servicePath string, rootDir string) bool {
