...
func TerminateS3(resource models.AWSResource, accessKey string, secretKey string)(error){return nil} 
 func TerminateEC2(resource models.AWSResource, accessKey string, secretKey string)(error){return nil}
 func TerminateALB(resource models.AWSResource, accessKey string, secretKey string)(error){return nil}
 func TerminateTargetGroup(resource models.AWSResource, accessKey string, secretKey string)(error){return nil}
  func TerminateListener(resource models.AWSResource, accessKey string, secretKey string)(error){return nil}