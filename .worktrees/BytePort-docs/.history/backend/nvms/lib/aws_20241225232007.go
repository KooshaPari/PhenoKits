...
func TerminateS3(resource models.AWSResource, accessKey string, secretKey string)(error){
	...
	err = c.DeleteBucket(context.Background(), resource.ARN)
	if err != nil {
		fmt.Println(err)
		return err
	}
 ...
 func TerminateEC2(resource models.AWSResource, AccessKey string, SecretKey string)(error){
	...
	err = c.DeleteInstance(context.Background(), resource.ARN)
	if err != nil {
		fmt.Println(err)
		return err
	}
	...
	return nil}
 func TerminateALB(resource models.AWSResource, accessKey string, secretKey string)(error){c, err := alb.NewALB(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
		Endpoint: getServiceEndpoint("elasticloadbalancing"),
	...
	err = c.DeleteALB(context.Background(), resource.ARN)
	if err != nil {
		fmt.Println(err)
		return err
	}
	fmt.Println("Record set created successfully.")
	 l}
 func TerminateTargetGroup(resource models.AWSResource, accessKey string, secretKey string)(error){c, err := ec2.NewEC2(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
		Endpoint: getServiceEndpoint("elasticloadbalancing"),
  ...
  func TerminateListener(resource models.AWSResource, accessKey string, secretKey string)(error){c, err := ec2.NewEC2(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
		Endpoint: getServiceEndpoint("elasticloadbalancing"),
	...
	err = c.DeleteInstance(context.Background(), resource.ID)
	if err != nil {
		fmt.Println(err)
		return err
	}
