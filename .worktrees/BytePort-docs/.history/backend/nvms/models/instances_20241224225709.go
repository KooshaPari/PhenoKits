...
type Instance struct {
	...
	RootProject    Project  `gorm:"foreignKey:RootProjectUUID;references:UUID"` // Establishes the relationship
	Resources	  []AWSResource `gorm:"foreignKey:InstanceUUID;references:UUID"`
