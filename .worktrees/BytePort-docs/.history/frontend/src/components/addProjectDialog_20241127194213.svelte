...
<Dialog.Root>
	...
	<Dialog.Content
		><Dialog.Header>
			...
			<Dialog.Description><h1>Select Repository</h1></Dialog.Description>
		</Dialog.Header>{#if stage ==1}<GitSearch />
		{:else if stage ==2} {:else if stage ==3} {:else if stage ==4{/if}<Dialog.Footer></Dialog.Footer></Dialog.Content
	>
</Dialog.Root>
