...
<Dialog.Root>
	...
	<Dialog.Content
		...
		<Dialog.Footer
			>{#if stage > 1}<Button.Root variant="ghost">Back</Button.Root><Button.Root variant="outline"
					>Next</Button.Root
				>{/if}</Dialog.Footer
		>
	</Dialog.Content>
