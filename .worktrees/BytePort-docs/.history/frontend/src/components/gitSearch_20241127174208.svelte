...
<Command.Root>
	...
	<Command.List>
		...
		<Command.Group heading="Suggestions">
			...
			<Command.Item>Git Emoji</Command.Item>
			<Command.Item>OpenAI</Command.Item>
		</Command.Group>
		<Command.Separator />
		<Command.Group heading="Settings">
			<Command.Item>AWS</Command.Item>
			<Command.Item>GCP</Command.Item>
			<Command.Item>Azure</Command.Item>
		</Command.Group>
	</Command.List>
</Command.Root>
