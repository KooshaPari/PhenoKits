		...
		<div id="mainBody">
			<div id="instanceSec" class="w-5/5 h-2/5 overflow-x-scroll">
				...
				<div id="instances" class="flex w-max overflow-y-visible p-2">
					...
					>
						<Icon
							class="hover:bg-dark-onPrimaryContainer active:bg-dark-onPrimary bg-dark-primary text-dark-onPrimary h-max w-3/5 rounded-full p-5 text-4xl hover:-translate-y-2 hover:scale-105 active:translate-y-1 active:scale-100"
