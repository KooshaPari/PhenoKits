		...
		<div id="mainBody">
			<div id="instanceSec" class="w-5/5 h-2/5 overflow-x-scroll">
				...
				<div id="instances" class="flex w-max overflow-y-visible p-2">
					<div
						class="hover:bg-dark-surfaceContainerHighestbg-dark-surfaceContainerHigh text-dark-onSurface m-0.5 mx-1.5 flex h-64 w-48 items-center justify-center rounded-lg transition-all"
					>
						<Icon
