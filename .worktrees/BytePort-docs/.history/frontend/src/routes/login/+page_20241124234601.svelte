			...
			<form class="flex-row" name="regUser" on:submit|preventDefault={login}>
				...
				<div>
					...
					<button
						...
						class="bg-dark-surfaceContainerHigh text-dark-onSurface hover:bg-dark-surfaceContainerHighest active:bg-dark-surfaceContainer my-3 rounded-full p-2 ransition-colors duration-150
