...
<section class="relative h-3/5 w-screen">
	<Dialog.Root>
		<Dialog.Trigger
			...
			<div
				class=" active:text-dark-surfaceVariant hover:bg-dark-onSecondaryContainer active:bg-dark-onPrimary bg-dark-primaryContainer text-dark-onPrimary m-5 w-3/5 rounded-lg p-5 text-4xl transition-all hover:-translate-y-2 hover:scale-105 active:translate-y-1 active:scale-100"
			>
