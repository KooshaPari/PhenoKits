			...
			<div id="projectsSec" class="w-5/5 h-2/5 overflow-x-scroll">
				...
				<div id="projects" class="flex w-max overflow-y-visible p-2">
					...
					{#each projects as project}
						<div
							class="hover:bg-dark-surfaceContainerHighest active:bg-dark-surfaceContainer bg-dark-surfaceContainerHigh text-dark-onSurface align-center align-center m-0.5 mx-1.5 flex flex h-64 w-48 flex-col items-center justify-center rounded-lg transition-all"
						>
							<div
