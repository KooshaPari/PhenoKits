...
<section class="w-screen h-3/5 relative"></section>
<Dialog.Root>
	<Dialog.Trigger
	...
	<Dialog.Content class=" max-w-fit  w-100   items-center justify-center space-y-4"
		><Dialog.Header>
		...
		<div class="vmView">
			...
			<div class="cardRight">
				...
				>
				<div id="resources" class="max-h-44 overflow-y-scroll">
					<Accordion.Root>
