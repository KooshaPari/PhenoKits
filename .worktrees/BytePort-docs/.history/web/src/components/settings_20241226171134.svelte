<script lang="ts" type="module">
	...
	export let item;
	export let id;
	export let data: { form: SuperValidated<typeof formSchema>; github?: any };
	const modals = [
	...
	console.log('Git: ', data.github);

	// Initialize form data if needed
	async function init() {
		if (!data.form) {
			data.form = await superValidate(zod(formSchema));
		}
	}
	init();
	console.log('Valdi: ', data.form);
	const { form, validate, enhance } = superForm(data.form, {
