<script lang="ts" type="module">
	...
	import SuperDebug, { type Infer, type SuperValidated, type SuperForm } from 'sveltekit-superforms';
	...
	const form: SuperForm<Record<string, unknown>> = superForm(data.form, {
