...
<form method="POST" class="space-y-8" use:enhance>
	{#if item == 'integrations'}
		<div class="openAICard align-center flex flex-row gap-3">
			<Form.Field class=" " name="github" {mform}>
				<Form.Control let:attrs>
					<Form.Label>Github Integration</Form.Label>
					<Input {...attrs} bind:value={$form.form.github} />
				</Form.Control>
				<Form.FieldErrors />
			</Form.Field>
			...
			<Form.Field {mform} name="modal" class="flex flex-col justify-center">
				<Popover.Root>
					<Form.Control let:attrs>
