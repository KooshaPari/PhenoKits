<script lang="ts">
	...
	const modals = [
		...
		{ label: 'Gemini 2.0 Flash', provider: 'gemini', value: 'gpt-4o' },
		{ label: 'Gemini 2.0 Flash', provider: 'gemini', value: 'gpt-4o-mini' },
		{ label: 'Gemini 2.0 Flash', provider: 'gemini', value: 'gpt-o1' },
