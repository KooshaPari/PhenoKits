...
export const formSchema = z.object({
	...
	llm: z.object({ provider: z.enum(['local', 'openai', 'gemini', 'anthropic'], { invalid_type_error: 'Select a provider', required_error: 'Please select a provider.' }), providers: z.record(z.string(), aiProviderSchema) });
