...
We provide security updates for the following versions of **BytePort**:
...
We take the security of **BytePort** seriously. If you discover a security vulnerability, please do NOT open a public issue. Instead, report it privately.
