...
func createHostedZone(ctx context.Context, domainName, region, vpcId string) {
...
<CreateHostedZoneRequest xmlns="https://route53.amazonaws.com/doc/2013-04-01/">
  ...
  <VPC>
	...
	req, err := http.NewRequestWithContext(ctx, "POST", "https://route53.amazonaws.com/doc/2013-04-01/hostedzone", bytes.NewReader([]byte(payload)))
