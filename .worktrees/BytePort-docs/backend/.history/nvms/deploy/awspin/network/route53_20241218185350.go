...
func(c *Client) createHostedZone(ctx context.Context, domainName, region, vpcId string) (error) {
...
<CreateHostedZoneRequest xmlns="https://route53.amazonaws.com/doc/2013-04-01/">
  ...
  <VPC>
	...
	resp, err := c.newRequest(ctx, http.MethodPost, "/hostedzone", []byte(payload))
	if err != nil {
