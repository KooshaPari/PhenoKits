...
func DeployNVMSService(AccessKey string, SecretKey string, BucketName string, service models.Service) error {
	instances, err := deployEC2(AccessKey, Secretkey, bucket.BucketName, service)
	if err != nil {
