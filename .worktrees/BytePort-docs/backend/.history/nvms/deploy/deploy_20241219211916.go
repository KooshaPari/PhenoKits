...
func DeployProject(w http.ResponseWriter, r *http.Request) {
	...
	*/
	...
	lbArn, listenArn, vpcId, err := provisionNetwork(accesskey, secretkey, project.Name, testArn)
	if err != nil {
	...
	testArn, err = createALBListener(accesskey, secretkey, project.Name, lbArn )
