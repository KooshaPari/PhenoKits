...
try {
    const files = [
        'C:/Users/koosh/Dino/.claude/sw_search/tatooine_buildings.json',
        'C:/Users/koosh/Dino/.claude/sw_search/star_wars_buildings.json',
        'C:/Users/koosh/Dino/.claude/sw_search/low_poly_star_wars.json'
    ];
    ...
    function processQuery(queryData, callback) {
        https.get(queryData.url, (res) => {
            ...
            res.on('end', () => {
                try {
                    ...
                    const filepath = `.claude/sw_search/${queryData.name}.json`;
    ...
    function finalize() {
        ...
        // Also save to file
        fs.writeFileSync('.claude/sw_search/candidates.json', JSON.stringify(output, null, 2));
    }
