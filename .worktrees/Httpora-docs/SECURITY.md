...
We provide security updates for the following versions of **Httpora**:
...
We take the security of **Httpora** seriously. If you discover a security vulnerability, please do NOT open a public issue. Instead, report it privately.
