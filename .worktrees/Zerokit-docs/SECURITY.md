...
We provide security updates for the following versions of **Zerokit**:
...
We take the security of **Zerokit** seriously. If you discover a security vulnerability, please do NOT open a public issue. Instead, report it privately.
