# Feature Specification: agent-wave - Core Setup & Compliance
...
This spec tracks the core setup and compliance work for agent-wave to achieve 100% governance coverage.
