# phenotype-cli-extensions User Journeys
...
|---------|----------|-------------|
| [Quick Start](./quick-start) | < 5 min | Get started with phenotype-cli-extensions |
...
flowchart TB
    ...
    subgraph phenotype-cli-extensions["phenotype-cli-extensions"]
        API[API Layer]
        Core[Core Engine]
        Storage[Storage]
    end
