# phenotype-docs-engine User Journeys
...
|---------|----------|-------------|
| [Quick Start](./quick-start) | < 5 min | Get started with phenotype-docs-engine |
...
flowchart TB
    ...
    subgraph phenotype-docs-engine["phenotype-docs-engine"]
        API[API Layer]
        Core[Core Engine]
        Storage[Storage]
    end
