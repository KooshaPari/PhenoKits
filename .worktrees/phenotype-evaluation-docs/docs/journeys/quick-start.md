...
<UserJourney
    :steps="[
        { title: 'Install', desc: 'Install phenotype-evaluation package' },
        { title: 'Configure', desc: 'Set up basic configuration' },
        { title: 'Run', desc: 'Execute first operation' }
    ]"
    :duration="5"
    :gif-src="'/gifs/phenotype-evaluation-quickstart.gif'"
/>
...
cargo add phenotype-evaluation
# or
npm install @phenotype-evaluation/core
```
