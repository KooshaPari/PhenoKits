...
//!
//! impl Contract for MemoryStorage {
//!     fn name() -> &'static str {
//!         "memory_storage"
//!     }
//!
...
//! verifier.verify::<MemoryStorage>().unwrap();
//! ```
...
impl ContractResult {
    ...
    pub fn success(contract_name: impl Into<String>, assertions: usize) -> Self {
        Self { passed: true, contract_name: contract_name.into(), assertions, failures: vec![] }
    }
    ...
    pub fn failure(
        ...
        Self { passed: false, contract_name: contract_name.into(), assertions, failures }
    }
}
