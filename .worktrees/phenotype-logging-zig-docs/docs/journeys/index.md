# phenotype-logging-zig User Journeys
...
|---------|----------|-------------|
| [Quick Start](./quick-start) | < 5 min | Get started with phenotype-logging-zig |
...
flowchart TB
    ...
    subgraph phenotype-logging-zig["phenotype-logging-zig"]
        API[API Layer]
        Core[Core Engine]
        Storage[Storage]
    end
