...
We provide security updates for the following versions of **phenotype-middleware-py**:
...
We take the security of **phenotype-middleware-py** seriously. If you discover a security vulnerability, please do NOT open a public issue. Instead, report it privately.
