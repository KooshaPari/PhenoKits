...
<UserJourney
    :steps="[
        { title: 'Install', desc: 'Install phenotype-nexus package' },
        { title: 'Configure', desc: 'Set up basic configuration' },
        { title: 'Run', desc: 'Execute first operation' }
    ]"
    :duration="5"
    :gif-src="'/gifs/phenotype-nexus-quickstart.gif'"
/>
...
cargo add phenotype-nexus
# or
npm install @phenotype-nexus/core
```
