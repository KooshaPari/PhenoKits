...
We provide security updates for the following versions of **phenotype-types**:
...
We take the security of **phenotype-types** seriously. If you discover a security vulnerability, please do NOT open a public issue. Instead, report it privately.
