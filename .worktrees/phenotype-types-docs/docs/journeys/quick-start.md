...
<UserJourney
    :steps="[
        { title: 'Install', desc: 'Install phenotype-types package' },
        { title: 'Configure', desc: 'Set up basic configuration' },
        { title: 'Run', desc: 'Execute first operation' }
    ]"
    :duration="5"
    :gif-src="'/gifs/phenotype-types-quickstart.gif'"
/>
...
cargo add phenotype-types
# or
npm install @phenotype-types/core
```
