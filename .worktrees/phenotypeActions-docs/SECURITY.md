...
We provide security updates for the following versions of **phenotypeActions**:
...
We take the security of **phenotypeActions** seriously. If you discover a security vulnerability, please do NOT open a public issue. Instead, report it privately.
