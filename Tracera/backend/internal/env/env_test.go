...
func TestGetRequired_Set(t *testing.T) {
	...
	require.NoError(t, os.Unsetenv("REQUIRED_VAR"))
}
...
func TestGetOrDefault_Set(t *testing.T) {
	...
	require.NoError(t, os.Unsetenv("DEFAULT_VAR"))
}
...
func TestGetIntOrDefault_Set(t *testing.T) {
	...
	require.NoError(t, os.Unsetenv("INT_DEFAULT_VAR"))
}
...
func TestGetBoolOrDefault_Set(t *testing.T) {
	...
	require.NoError(t, os.Unsetenv("BOOL_DEFAULT_VAR"))
}
...
func TestGetDurationOrDefault_Set(t *testing.T) {
	...
	require.NoError(t, os.Unsetenv("DURATION_DEFAULT_VAR"))
}
...
func TestSet(t *testing.T) {
	...
	require.NoError(t, os.Unsetenv("SET_VAR"))
}
...
func TestValidate_AllSet(t *testing.T) {
	...
	require.NoError(t, err)
	require.NoError(t, os.Unsetenv("VAR1"))
	require.NoError(t, os.Unsetenv("VAR2"))
	require.NoError(t, os.Unsetenv("VAR3"))
}
...
func TestMultipleOperations(t *testing.T) {
	...
	require.NoError(t, os.Unsetenv("KEY3"))
}
...
func TestZeroValues(t *testing.T) {
	...
	assert.Empty(t, manager.Get("EMPTY_STRING"))
	...
	require.NoError(t, os.Unsetenv("EMPTY_STRING"))
	require.NoError(t, os.Unsetenv("ZERO_INT"))
	require.NoError(t, os.Unsetenv("FALSE_BOOL"))
	require.NoError(t, os.Unsetenv("ZERO_DURATION"))
}
