...
- Strict web type-aware lint triage is captured in `07_TYPE_AWARE_LINT_TRIAGE.md`.
  ...
  test-support errors. After thirteen production tranches, full strict errors are down
  from 2,503 to 1,758 and `typecheck:web` remains green. Continue production cleanup
