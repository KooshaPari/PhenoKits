...
function CoverageBadge({
  ...
  coveredCount,
  totalFeatures,
}: CoverageBadgeProps): ReactElement {
  if (status === 'covered') {
    return (
...
export function TraceabilityMatrixView({
  projectId,
}: TraceabilityMatrixViewProps): ReactElement {
              ...
              {matrix.requirements.map((req) => {
                ...
                return (
                  ...
                  >
                    ...
                    {matrix.features.map((feature) => {
                      const isLinked = matrix.coverage[req.id]?.has(feature.id) ?? false;
                      return (
                        <td
                          key={feature.id}
                          className={cn(
