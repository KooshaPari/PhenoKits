...
echo "📋 Next Steps:"
echo ""
echo "1. Start the shared collector stack (optional, for viewing traces):"
echo "   make dev"
echo ""
echo "2. Set environment variables:"
echo "   export PHENO_OBSERVABILITY_OTLP_GRPC_ENDPOINT=127.0.0.1:4319"
