...
**scripts** — Central automation and tooling repository for the Phenotype ecosystem

## Project Summary

This project provides standardized, reusable scripts that streamline development workflows, enforce quality gates, and automate repetitive tasks.

## Stack

| Layer | Technology | Version |
|-------|------------|---------|
| Language | Python/Bash | 3.14 |
