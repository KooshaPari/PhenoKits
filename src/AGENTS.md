...
**src** — Foundational infrastructure for AI-native tooling implementing the Model Context Protocol (MCP)

## Project Summary

This project provides MCP specification implementation enabling secure, standardized integration between AI systems and external tools.
